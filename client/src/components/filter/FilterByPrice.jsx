...
import PriceFilterButon from "../buttons/PriceFilterButton";
                ...
                {isOpen && (
                    <div className="absolute mx-7 md:right-0 z-10 mt-1 w-48  rounded-md bg-white shadow-2xl ring-1 ring-black ring-opacity-5 focus:outline-none dark:border-darkBlue dark:placeholder-gray-400  dark:bg-darkBlue" role="menu" aria-orientation="vertical" aria-labelledby="menu-button" tabIndex="-1" >
                        <div className="flex flex-col items-center " role="none">
                            <div className="ml-2">
                                <label className=" text-xs cursor-pointer font-extrabold">Minimum</label>
                                <input className="rounded border border-green" />
                            </div>
                            <div className="ml-2"> 
                                <label className="text-xs cursor-pointer font-extrabold">Maximum</label>
                                <input className="rounded border border-green" />
                            </div>
                            <div className="my-3">
                                <PriceFilterButon />
